...
public class GoldSeeker implements Seeker {
   ...
   * Constructor.
   *
   * @param nav injected naviagator
   * @param map injected map
   */
   ...
   */
  public long getNextMove(long currentLocation,
                          Collection<? extends HasIdAndDistance> neighbours,
                          int timeRemaining) throws IllegalStateException {
   ...
   */
  @Override
  public long getNextMove(long currentLocation, Collection<? extends HasIdAndDistance> neighbours)
  ...
  /**
   * Get the ID for the attached node holding the largest amount of gold.
   *
   * @return ID of located node
   */
   ...
   *
   * @param navigator the new navigator value
   */
  ...
  /**
   * Setter for the current location id.
   *
   * @param currentLocationId the new current location id
   */
   ...
   *
   * @param timeRemaining the new timeRemaining value
   */
